        ...
        <View style={styles.container}>
          <View style={styles.imageStack}>
            ...
            <View style={[stylesFooter.container, styles.cupertinoFooter1]}>
              <TouchableOpacity
                ...
                <MaterialCommunityIconsIcon
                  name="home"
                  style={stylesFooter.icon}></MaterialCommunityIconsIcon>
                <Text>Homepage</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <IoniconsIcon
                  name="ios-book"
                  style={stylesFooter.icon1}></IoniconsIcon>
              ...
              <TouchableOpacity
                ...
                <MaterialCommunityIconsIcon
                  ...
                  style={stylesFooter.icon3}></MaterialCommunityIconsIcon>
              ...
              <TouchableOpacity
                ...
                <MaterialCommunityIconsIcon
                  name="account"
                  style={stylesFooter.icon2}></MaterialCommunityIconsIcon>
                <Text style={stylesFooter.thongKe}>Người dùng</Text>
              </TouchableOpacity>
            </View>
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() =>
                this.props.navigation.navigate('SidemenuNotloggedin')
              }>
              <ImageBackground
